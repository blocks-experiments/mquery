...
watchBreakpoints(_device.sizes, (active) => {
  ...
  // e.g 
    ...
    elements.forEach(el => {
        ...
        el = el || clientState.result['navElem'].el;
        parentElement = parentElement || clientState.result['navElem'].parentElement;
        let refSibling = clientState.result['navElem'].refSibling;
