...
watchBreakpoints(_device.sizes, (active) => {
  ...
  // e.g 
    ...
    //     const _el = clientState.result['navElem'].el;
    //     const _parentElement = clientState.result['navElem'].parentElement;
    ...
    //     // console.log(active.pos === targetSize);
    ...
    //       // if (refSibling) 
    //         // if (refSibling) {
    //           refSibling.replaceWith(_el)
    //         // }

    //         // refSibling.remove();
    //         // console.log('if nav, change to div')
            
    //         // else {
    //         //   console.log('replace na')
    //         // }
    //         // else 
    //       // if (el && refSibling) refSibling.replaceWith(el);
    ...
    //     // if (active.pos === targetSize) {
    //     //   console.log('Yay!');
    //     //   if (refSibling) refSibling.replaceWith(_el);
    //     //     // else 
    //     //   // if (el && refSibling) refSibling.replaceWith(el);
    ...
    //     // } else {
    //     //   console.log('Na...');
    //     //   if (el) el.replaceWith(_refSibling);
